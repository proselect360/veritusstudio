...
export const metadata = {
  ...
  description: "Sitio web completo con blog, SEO avanzado y diseño que transmite autoridad. Desde $3.800.000 COP.",
}
      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-slate-700 max-w-4xl mx-auto font-medium">
            Sitio web completo con Next.js, blog integrado, SEO avanzado y diseño que transmite autoridad y confianza.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-indigo-900/5 to-purple-900/5 rounded-3xl p-8 border border-indigo-900/10">
              ...
              <p className="text-lg text-slate-700 font-medium">
                Pymes establecidas, clínicas, abogados, consultoras
              </p>
            </div>

            <ul className="space-y-6">
              {[
                "Múltiples páginas (Inicio, Servicios, Sobre nosotros, Contacto)",
                "Blog profesional integrado",
                "SEO técnico avanzado incluido",
          ...
          <div className="bg-gradient-to-br from-indigo-600/10 to-purple-600/10 rounded-3xl p-12 backdrop-blur-sm border border-indigo-600/20">
            ...
            <ul className="space-y-4 text-lg text-slate-700">
              <li>• Empresas consolidadas</li>
              <li>• Profesionales que quieren autoridad online</li>
              <li>• Negocios que necesitan blog para posicionarse</li>
              <li>• Clínicas, estudios jurídicos, consultorías</li>
            </ul>
          </div>
        </div>
        ...
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-8">
            Transmite confianza y profesionalismo desde el primer clic
          </h2>
