...
export default function FAQSection() {
  ...
  return (
    /* EL ID ES LA CLAVE: id="faq" permite que el footer te traiga aquí */
    <section id="faq" className="relative py-32 bg-transparent overflow-hidden transition-colors duration-500 isolate">
      ...
      {/* Pilar SEO: Datos Estructurados para Google Search */}
      <script
