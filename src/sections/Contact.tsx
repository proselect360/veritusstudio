        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          >
            ...
            <h2 className="text-5xl md:text-7xl lg:text-7xl font-black tracking-tight leading-[0.95] mb-6 md:mb-10 text-white">
              Hagamos algo <br />
              <span className="text-transparent bg-clip-text bg-linear-to-r from-indigo-400 via-purple-400 to-emerald-400 italic">
                extraordinario.
              </span>
            </h2>

            <p className="text-lg md:text-xl font-medium leading-relaxed max-w-md mb-8 md:mb-12 text-slate-400">
              Transformamos visiones en <span className="text-white">ingeniería de software</span> de alto impacto.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3 md:gap-4 max-w-sm lg:max-w-none">
              <ContactCard
                ...
                label="Escríbenos"
                value="contacto@veritusstudio.co"
                href="mailto:contacto@veritusstudio.co"
              />
              <ContactCard
            ...
            <AnimatePresence mode="wait">
              {!submitted ? (
                <motion.form
                  ...
                  className="relative bg-slate-900/40 backdrop-blur-3xl border border-white/10 rounded-4xl md:rounded-[3rem] p-6 md:p-12 shadow-2xl"
                >
                  ...
                  <div className="space-y-2 mb-8 md:mb-10">
                    ...
                    <textarea
                      ...
                      required rows={3}
                      className="w-full bg-white/5 border border-white/10 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-3xl px-5 py-4 transition-all font-medium text-white placeholder:text-slate-500 outline-none resize-none text-sm md:text-base"
                  ...
                  <button
                    ...
                    type="submit"
                    className="group w-full py-5 md:py-6 bg-indigo-600 hover:bg-indigo-500 text-white rounded-3xl md:rounded-4xl font-black text-sm md:text-lg flex items-center justify-center gap-4 transition-all shadow-xl shadow-indigo-500/20 active:scale-95 disabled:opacity-50"
                  >
                    {isSubmitting ? (
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1, scale: 1 }}
                  className="bg-slate-900/40 border border-white/10 rounded-4xl p-10 text-center backdrop-blur-3xl shadow-2xl"
                >
...
function ContactCard({ icon, label, value, href }: any) {
  return (
    <a
      ...
      className="flex items-center gap-4 p-4 rounded-3xl border border-white/5 bg-white/5 hover:bg-white/10 transition-all group"
    >
      <div className="w-10 h-10 md:w-12 md:h-12 shrink-0 bg-indigo-500/10 text-indigo-400 rounded-xl flex items-center justify-center transition-transform group-hover:scale-105">
        {icon}
      </div>
