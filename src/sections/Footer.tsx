        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-base leading-relaxed max-w-sm font-medium">
              Ecosistemas digitales de alto rendimiento en Colombia. Ingeniería de software premium con <span className="text-indigo-600 dark:text-indigo-400 font-bold">Next.js 15</span>.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="mailto:contacto@veritusstudio.co" className="text-sm font-bold text-slate-800 dark:text-slate-200 hover:text-indigo-600 transition-colors block break-all">
                contacto@veritusstudio.co
              </a>
