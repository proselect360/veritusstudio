...
export default function Footer() {
  ...
  // Rutas corregidas con "/" al inicio para que funcionen desde el blog
  const services = [
  ...
  // Enlace de guía de precios corregido (sin la palabra "una")
  const resources = [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
               {/* Instagram */}
               <a href="https://instagram.com/veritusstudio" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-pink-600 transition-colors">
               ...
               {/* LinkedIn */}
               <a href="https://linkedin.com/company/veritusstudio" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-blue-700 transition-colors">
