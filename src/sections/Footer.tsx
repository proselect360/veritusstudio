        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              {/* Instagram - Corregido aria-label y contraste */}
              <a 
              ...
              {/* LinkedIn - Corregido aria-label y contraste */}
              <a 
          ...
          {/* Columna 2: Recursos (SEO) - Cambiado a h3 */}
          <div>
            <h3 className="text-xs font-bold text-slate-900 uppercase tracking-widest mb-6">Recursos Educativos</h3>
          ...
          {/* Columna 3: Servicios - Cambiado a h3 */}
          <div>
            <h3 className="text-xs font-bold text-slate-900 uppercase tracking-widest mb-6">Servicios</h3>
            <ul className="space-y-4">
          ...
          {/* Columna 4: Contacto - Cambiado a h3 */}
          <div className="space-y-6">
            <div>
